#Graphs related to the observational data of "The Pundit Paradox"
...
wd = "C:/Users/gasca/OneDrive - Università degli Studi di Milano-Bicocca/Dottorato/Papers and Chapters/Negri Scaduto 2024/Pundit_Paradox_Rep_Files"

output_dir_graph = paste0(wd, "/outputs/talk/eng/")
...
ggsave("guests_by_profession_and_show_total_eng.png", path=output_dir_graph, width = 10, height = 5)
...
ggsave("guests_by_show_and_profession_scholars_eng.png", path=output_dir_graph, width = 10, height = 5)
...
ggsave("genderbias_eng.png", path=output_dir_graph, width = 10, height = 5)
...
ggsave("Age_range_by_show_average_eng.png", path=output_dir_graph, width = 10, height = 5)
